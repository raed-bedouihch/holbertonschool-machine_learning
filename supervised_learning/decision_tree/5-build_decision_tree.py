...
class Node:
    ...
    def update_indicator(self):
        """Update the indicator of the leaves below the current node."""
        def is_large_enough(x):
            """Check if the value of the feature
...
class Decision_Tree():
    ...
    def depth(self):
        """returns maximum depth of a decision tree"""
